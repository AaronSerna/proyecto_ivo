  ...
  initDataTable() {
    this.dtOptions = {
      ...
      columns: [
        ...
        { title: 'Nombre del médico', data: 'nombre_completo_medico' },
...

        {
          ...
          render: function (data: any, type: any, full: any) {
            ...
            return (
              ...
              `<a href="http://localhost:4200/administrativo/modificarCita?numCita=${numCita}&nombrePaciente=${nombrePaciente}&fecha=${fecha}&hora=${hora}"><img class="custom-imagen-1" src="../../../../../assets/images/ImagenesAdministrativo/editar.svg" alt=""></a>` +
