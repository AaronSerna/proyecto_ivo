...
import { UsuariosService } from 'src/app/services/servicio-usuarios/usuarios.service';
...
export class ComponenteResumenDatosPacienteComponent {
  ...
  confirmacionCrearPaciente(){
    this.usuariosService.crearUsuarioPaciente({
      nombre: this.nombre,
        ...
        this.router.navigate(
          ['administrativo/crearCita/crearCitaPaso1/crearCitaPaso2'],
          {
            queryParams: {
              ...
              dni: encodeURIComponent(this.dniPaciente),
              fecha_nacimiento: encodeURIComponent(this.fechaNacimiento),
